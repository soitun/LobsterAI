...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkAddFile: '添加文件',
    voiceInput: '语音输入',
    voiceInputPermissionDenied: '语音输入需要辅助功能权限，请前往 系统设置 → 隐私与安全性 → 辅助功能 中开启',
  ...
  en: {
    ...
    voiceInputPermissionDenied: 'Voice input requires Accessibility permission. Please enable it in System Settings → Privacy & Security → Accessibility',
